...
const locations = [
  ...
  'Texas Desert Installation',
  'Arizona Array Site',
  'Nevada Solar Park',
  'New Mexico Grid',
  'Colorado Mountain Array',
  'Oregon Coast Installation',
  'Washington Valley Site',
  'Utah Desert Farm',
  'Idaho Solar Grid',
  'Montana Plains Array',
  'Wyoming Solar Park',
];
...
export const mockApi = {
  ...
  async updateAsset(id, updates) {
    ...
    mockAssets = [...mockAssets.slice(0, index), updatedAsset, ...mockAssets.slice(index + 1)];
